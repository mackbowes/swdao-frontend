...
import { SIDE_PADDING, WIDTHS } from './Header'
...
const walletIcon = (
    <Image src="/images/swd-logo-sm-white.png" alt="SW DAO Logo" h="25px" />
)
            ...
            >
                <ModalHeader padding="0">
                    <Box
                        className="header"
                        margin="0.5 auto"
                        padding={`0.5em ${SIDE_PADDING[breakpoint]}`}
                    >
                        <Flex
                            flexFlow="row nowrap"
